...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/jielumoon/sub2api-fork:latest
...
SUB2API_IMAGE=ghcr.io/jielumoon/sub2api-fork:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.

...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Jielumoon/sub2api-fork/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Jielumoon/sub2api-fork"
...
Documentation=https://github.com/Jielumoon/sub2api-fork

...
curl -sSL https://raw.githubusercontent.com/Jielumoon/sub2api-fork/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Jielumoon/sub2api-fork/releases)

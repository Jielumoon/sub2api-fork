<template>
  <div>
    ...
    <button
      @click="openModal"
      class="relative flex h-9 w-9 items-center justify-center rounded-lg text-gray-600 transition-all hover:bg-gray-200/60 hover:scale-105 dark:text-gray-400 dark:hover:bg-dark-800"

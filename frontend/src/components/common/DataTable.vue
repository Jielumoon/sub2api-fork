...
.table-wrapper::-webkit-scrollbar-thumb {
  background-color: theme('colors.gray.500 / 75%') !important;
  border-radius: 6px !important;
...
.table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: theme('colors.gray.600 / 90%') !important;
}

.dark .table-wrapper::-webkit-scrollbar-thumb {
  background-color: theme('colors.dark.400 / 75%') !important;
}
.dark .table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: theme('colors.dark.300 / 90%') !important;
}
...
@supports (-moz-appearance:none) {
  .table-wrapper {
    ...
    scrollbar-color: theme('colors.gray.400 / 50%') rgba(0, 0, 0, 0.03) !important;
  }
  .dark .table-wrapper {
    scrollbar-color: theme('colors.dark.600 / 50%') rgba(255, 255, 255, 0.05) !important;
  }
}
</style>

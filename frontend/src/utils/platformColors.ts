...
const ACCENT_DEFAULT = '#d97757' // primary-500；已知平台保留各自品牌色
...
const BUTTON_DEFAULT = 'bg-primary-600 text-white hover:bg-primary-700 dark:bg-primary-600 dark:hover:bg-primary-700'
